                    ...
                    <div className='lg:col-auto md:col sm:col-span-3 col xl:space-y-3.5 space-y-2'>
                        ...
                        <div className='sm:space-y-2 space-y-1.5 xl:text-base text-sm'>
                            ...
                            <a className='block text-sm sm:text-base hover:underline' href="tel:+1 (406) 555-0120">
                                <Phone fontSize='inherit' /> (+91)-8695741236
                            </a>

                            {/* Email */}
                            <a className='block text-sm sm:text-base hover:underline' href="#">
                                <Mail fontSize='inherit' /> grocery-store@gmail.com
                            </a>

                            {/* Address (fake)*/}
                            <address>
                                <LocationOn fontSize='inherit' />GST Road, Tambaram, Chennai
                            </address>
                        </div>
                    </div>
                </div>
